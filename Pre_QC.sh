...
## For relatedness estimation with KING
# Get a list of unrelated individuals
king -b For_PCA_maf5_geno2_mind5_hwe.bed --unrelated --degree 2

# Get pairwise relatedness degree estimations
king -b For_PCA_maf5_geno2_mind5_hwe.bed --related  --degree 2 --rplot --prefix king_output
